...
setwd("C:/Rwd-coursera/Course-Practical Machine Learning") # Set work directory
...
```{r, echo=TRUE, chunk-out-sample-accuracy, message=FALSE}
...
For this analysis we "Random Forest"  machine learning algorithm was selected as it gave highest accuracy classifier on test dataset and also the algorithm balances bias and variance trade-offs by settling for a balanced model.
